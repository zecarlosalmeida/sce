...
@WebServlet("/ingrediente/atualizar")
public class ManterIngredientesAtualizar extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static String DESTINO = "/ingrediente/listar.jsp";
	private static String FORM = "/ingrediente/editarIngrediente.jsp";
